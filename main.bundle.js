...
/***/ (function(module, exports, __webpack_require__) {
	...
	const Meal = __webpack_require__(4);
	const Meals = __webpack_require__(5);
	var host = __webpack_require__(3).host;
	...
	$(function () {
	  ...
	  $("#sort_by_calories").on("click", function (event) {
	    ...
	    if (sortStyle === "desc") {
	      Food.getAllFoods().then(createMealFoodsTable).then(function () {
...
/***/ (function(module, exports, __webpack_require__) {
	...
	function Meal(data, calories) {
	  this.foodName = data.food_name, this.foodCalories = data.food_calories;
	...
	Meal.allFoodsToHTML = function (meal) {
	  return this.getMeal(meal).then(meals => {
	...
	Meal.updateTable = function (mealName, length) {
	  Meal.allFoodsToHTML(mealName).then(data => {
	...
	Meal.reloadAll = function () {
	  Object.keys(meals).forEach(function (meal) {
	    ...
	    Meal.allFoodsToHTML(meal, meals[meal]).then(function (data) {
